...
public class U2FRegisterRequest extends RequestBody {
    public static final String FIELD_NAME = "u2f_register_request";
    ...
    public View fillView(ConstraintLayout container) {
        ...
        String baseText = "Register for " + KnownAppIds.displayAppId(appId);
